...
const DisplayAlbum = () => {
  ...
  // safety check
  if (!albumData) {
    return <p className="text-white p-5">Album not found</p>
  }
  ...
  return (
    <>
      ...
      <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
        <img className='w-28 rounded' src={albumData.image} alt={albumData.name} />
        ...
        <div className='flex flex-col'>
          ...
          <p className='mt-1 flex items-center gap-2'>
            ...
            <b>Spotify</b> • 1,233,445 likes • <b>50 songs</b>, about 2 hr 30 min
          </p>
        </div>
      </div>
