  ...
  return (
    <div className="w-[25%] h-full p-2 flex flex-col gap-2 text-white">
      ...
      <div className="bg-[#121212] h-[85%] rounded p-4">
        ...
        <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justity-start gap-1 pl-4'>
           <h1>Create your first playlist</h1>
           <p className='font-light'>It's easy we will help you</p>
           <button className='px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4'>Create playlist</button>
        </div>
        <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justity-start gap-1 pl-4 mt-4'>
           <h1>Let's findsome podcasts to follow</h1>
           <p className='font-light'>we'll keep update on new episodes</p>
           <button className='px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4'>Browser podcasts</button>
        </div>
      </div>
